...
public class LKKExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(LKKDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new LKKStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static LKKDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static LKKDateTimeConverter dateTimeConverter = new LKKStandardDateTimeConverter();

    public LKKExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public LKKExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new LKKMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=LKKHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,LKKExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=LKKHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
