...
public class LKKKPSPublicSoap
{
    interface LKKIWcfMethod
    {
        LKKExtendedSoapSerializationEnvelope CreateSoapEnvelope() throws java.lang.Exception;

        java.lang.Object ProcessResult(LKKExtendedSoapSerializationEnvelope __envelope,java.lang.Object result) throws java.lang.Exception;
    }
    ...
    public LKKKPSPublicSoap(){}

    public LKKKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public LKKKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    protected LKKExtendedSoapSerializationEnvelope createEnvelope()
    {
        LKKExtendedSoapSerializationEnvelope envelope= new LKKExtendedSoapSerializationEnvelope(LKKExtendedSoapSerializationEnvelope.VER11);
        envelope.enableLogging = enableLogging;
    
        return envelope;
    }

    protected java.util.List sendRequest(String methodName,LKKExtendedSoapSerializationEnvelope envelope,org.ksoap2.transport.Transport transport ,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile )throws java.lang.Exception
    {
    ...
    java.lang.Object getResult(java.lang.Class destObj,java.lang.Object source,String resultName,LKKExtendedSoapSerializationEnvelope __envelope) throws java.lang.Exception
    {
        if(source==null)
        {
            return null;
    ...
    public Boolean TCKimlikNoDogrula(final String TCKimlikNo,final String Ad,final String Soyad,final String DogumYili) throws java.lang.Exception
    {
        ...
        return (Boolean)execute(new LKKIWcfMethod()
        {
            @Override
            public LKKExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                LKKExtendedSoapSerializationEnvelope __envelope = createEnvelope();
            ...
            @Override
            public java.lang.Object ProcessResult(LKKExtendedSoapSerializationEnvelope __envelope,java.lang.Object __result)throws java.lang.Exception {
    ...
    protected java.lang.Object execute(LKKIWcfMethod wcfMethod,String methodName,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile) throws java.lang.Exception
    {
        org.ksoap2.transport.Transport __httpTransport=createTransport();
        __httpTransport.debug=enableLogging;
        LKKExtendedSoapSerializationEnvelope __envelope=wcfMethod.CreateSoapEnvelope();
        try
        {
    ...
    protected java.lang.Exception convertToException(org.ksoap2.SoapFault fault,LKKExtendedSoapSerializationEnvelope envelope)
    {
