...
public class LKKKPSPublicSoap12
{
    ...
    public LKKKPSPublicSoap12(){}

    public LKKKPSPublicSoap12(String url)
    {
        this.url = url;
    }

    public LKKKPSPublicSoap12(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        LKKExtendedSoapSerializationEnvelope envelope= new LKKExtendedSoapSerializationEnvelope(LKKExtendedSoapSerializationEnvelope.VER12);
